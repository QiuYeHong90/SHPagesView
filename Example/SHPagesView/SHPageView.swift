...
protocol SHPageChildUIViewContoller: UIViewController {
    func shGetAllInteractScrollView() -> [UIScrollView];
}

protocol SHPageViewDelegate: NSObjectProtocol {
    func shPagedataSourceViewController(pageView: SHPageView) -> [SHPageChildUIViewContoller];
    
}

class SHPageView: UIView {
    lazy var tableView: SHPageTableView = {
    ...
    weak var delegate: SHPageViewDelegate?
